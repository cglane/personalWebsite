    ...
    .directive('aboutDirective', function () {
      return {
        ...
        link: function (scope, element, attributes) {
          ...
          {date:2012,information:'Moved to Beijing, China and , taught English',photo:'../../Photos/wall.jpg'},
          ...
          {date:2014,information:'Moved back to Charleston,started work with Tupper Builders, as a cabinet maker'},
          {date:2015,information:'Started at The Iron Yard in Front End Engineering Program',photo:'../../Photos/coffee.jpg'},
          ...
          var currentIndex = 0;
          // var changingView = function(){
          //   console.log('changingView');
          //   currentIndex <= scope.timeline.length?currentIndex++:currentIndex = 0;
